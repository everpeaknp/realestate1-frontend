  ...
  return (
    <>
      <div className="my-8 sm:my-10 md:my-12">
        <h3 className="text-xl sm:text-2xl font-bold text-[#1a1a1a] mb-4 sm:mb-6 font-sans">
          Gallery
        </h3>
        ...
        {selectedImage && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setSelectedImage(null)}
                className="absolute -top-10 sm:-top-12 right-0 text-white hover:text-[#c1a478] transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
              ...
              {selectedImage.caption && (
                <div className="mt-3 sm:mt-4 bg-white/10 backdrop-blur-sm rounded-sm p-3 sm:p-4">
              ...
              <div className="absolute top-1/2 -translate-y-1/2 left-2 right-2 sm:left-4 sm:right-4 flex justify-between pointer-events-none">
                <button
                  ...
                  className="pointer-events-auto bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white p-2 sm:p-3 rounded-full transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
