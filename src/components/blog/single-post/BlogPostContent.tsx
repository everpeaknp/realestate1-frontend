...
export default function BlogPostContent({ content }: BlogPostContentProps) {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <div 
        className="prose prose-sm sm:prose-base lg:prose-lg max-w-none text-[15px] sm:text-[17px] leading-[1.7] sm:leading-[1.8] text-[#5d6d87] mb-12 sm:mb-16 space-y-6 sm:space-y-8 font-sans"
        dangerouslySetInnerHTML={{ __html: content }}
      />

      {/* Social Sharing Icons */}
      <div className="mt-6 sm:mt-8 flex flex-wrap gap-2 sm:gap-3 justify-center pt-6 sm:pt-8 border-t border-gray-100">
        <button 
          onClick={() => {
