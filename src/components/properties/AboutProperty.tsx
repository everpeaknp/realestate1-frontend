    ...
    <section className="bg-white py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6">
          <motion.div
            className="border border-gray-100 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col items-center justify-center text-center aspect-square hover:shadow-lg transition-all duration-300 rounded-xl cursor-pointer hover:-translate-y-1"
