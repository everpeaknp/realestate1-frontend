...
const PropertyCard: React.FC<PropertyCardProps> = ({ property }) => {
  ...
  return (
    ...
    >
      <Link href={detailHref} className="block" aria-label={`View ${property.title}`}>
        ...
        <div className="flex flex-col gap-3 px-1">
          ...
          <div className="pt-3">
            <div className="inline-flex items-center gap-2 font-sans text-[10px] font-bold tracking-widest uppercase text-brand-primary border-b border-brand-primary/20 pb-1 group-hover:border-brand-primary group-hover:gap-3 transition-all duration-300">
