  ...
  return (
    <section className="bg-white py-8 sm:py-12 pb-0 overflow-hidden">
      ...
      <div className="flex items-center justify-center gap-2 sm:gap-3 mb-8 sm:mb-12 px-4">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#091E34' }}>
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
          <polyline points="14 2 14 8 20 8"/>
          <line x1="16" y1="13" x2="8" y2="13"/>
          <line x1="16" y1="17" x2="8" y2="17"/>
        </svg>
        <h2 style={{ color: '#091E34' }} className="text-xs sm:text-[13px] font-bold tracking-[0.15em] sm:tracking-[0.2em] uppercase">
          Latest Blog Posts
        </h2>
      </div>
          ...
          {posts.map((post, index) => (
            ...
            >
              <Link href={`/blog/${post.slug}`} className="block w-full h-full">
                ...
                />
                {/* Hover overlay */}
                <div style={{ backgroundColor: 'rgba(9, 30, 52, 0.4)' }} className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
