...
export default function InstagramGallery() {
  ...
  return (
    <section className="bg-white py-8 sm:py-12 pb-0 overflow-hidden border-t border-black/5">
      {/* Header */}
      <div className="flex items-center justify-center gap-2 sm:gap-3 mb-8 sm:mb-12 px-4">
        ...
        <h2 className="text-black text-xs sm:text-[13px] font-bold tracking-[0.15em] sm:tracking-[0.2em] uppercase">
          Latest Blog Posts
        </h2>
      </div>
          ...
          {posts.map((post, index) => (
            ...
            >
              <Link href={`/blog/${post.slug}`} className="block w-full h-full">
                ...
                />
                {/* Hover overlay */}
                <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }} className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
